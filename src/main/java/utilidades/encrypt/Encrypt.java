package utilidades.encrypt;

import utilidades.enums.enumsEncrypt.EnumMsgEncrypt;
...
public class Encrypt {
  ...
  private static final String SECRET_KEY = EnumMsgEncrypt.PHRASSE_SECURITY.getMensaje();
  ...
  public static String encrypt(String texto) {
    ...
    try {
      ...
      LOGGER.log(Level.WARNING, EnumMsgEncrypt.ENCRYPT_ERROR.getMensaje(), e);
    }
  ...
  public static void main(String[] args) {
    ...
    //LOGGER.log(Level.INFO, decrypt("NiyR66Odo09TH/7d3UcFskCZeaHtLe9Wx2c7Sri3O6258ljgz/a052OyRKOja7iZ"));
  }
  ...
  public static String decrypt(String textoEncriptado) {
    ...
    try {
      ...
      base64EncryptedString = new String(plainText, StandardCharsets.UTF_8);
        ...
        | NoSuchPaddingException
        | InvalidKeyException e) {
      LOGGER.log(Level.WARNING, EnumMsgEncrypt.DECRYPT_ERROR.getMensaje(), e);
    }
    return base64EncryptedString;
  }
